...
function draw() {
    ...
    if(gameState===PLAY){
        ...
        if (sharkG.isTouching(diver)||bombG.isTouching(diver)) {
            gameState=END
                var gameover=createSprite(215,250)
                ...
                sharkG.setVelocityYEach(0);
                bombG.setVelocityYEach(0);
                goldbarG.setVelocityYEach(0);    
                jewelnecklaceG.setVelocityYEach(0);   
                jewelringG.setVelocityYEach(0);   
                diamondG.setVelocityYEach(0);   
                treasurechestG.setVelocityYEach(0); 
        }
        }
    ...
    function createObstacle1(){
        ...
        goldbarG.velocityY = -(6 + score/100);
        }
    }
     ...
     function createObstacle2() {
            ...
            jewelnecklace.velocityY = 3;
            jewelnecklace.lifetime = 200;
            jewelnecklaceG.add(jewelnecklace);
            jewelnecklaceG.velocityY = -(6 + score/100);
     }
    }
    ...
    function createObstacle3() {
        ...
        jewelring.scale=0.2;
        jewelring.velocityY = 3;
        jewelring.lifetime = 200;
        jewelringG.add(jewelring);
        jewelringG.velocityY = -(6 + score/100);
    }
    }
    ...
    function createObstacle4() {
        ...
        diamondG.velocityY = -(6 + score/100);
    }
    }
    ...
    function createObstacle5() {
        ...
        treasurechest.velocityY = 3;
        treasurechest.lifetime = 200;
        treasurechestG.add(treasurechest);
        treasurechestG.velocityY = -(6 + score/100);
    }
    }
